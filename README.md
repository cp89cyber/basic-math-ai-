...
- Enter a problem like `2+2`, `-9*4`, `9007199254740993+2`, or `9007199254740993123/3`.
...
- Supported operators: `+`, `-`, `*`, `/`
- Inputs may be arbitrarily large signed integers.
- Division by zero is rejected.
- Division must resolve to a whole number.
